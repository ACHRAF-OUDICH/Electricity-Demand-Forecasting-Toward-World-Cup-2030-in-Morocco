Prédiction de la Demande d'Électricité au Maroc - Objectif Coupe du Monde 2030
===========================================================================

.. container:: release

   * **Auteurs :** Younes Chajara & Achraf Oudich
   * **Institution :** École Nationale Supérieure d'Arts et Métiers (ENSAM), Meknès
   * **Spécialisation :** Intelligence Artificielle et Technologies de Données pour les Systèmes Industriels (IATD-SI)
   * **Statut :** Recherche Académique | Actif (2025–2026)
